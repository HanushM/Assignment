...
class CSVFileStorageRetrival
{
    ...
    public static void loadEmployeeDataFromFile(HashMap<Integer, Employee> employees)
    {
        File file = new File(FILE_NAME);
        if (!file.exists()) {
            try {
                if (file.createNewFile()) {
                    System.out.println("File not found, a new file was created.");
                } else {
    ...
    public static void updateEmployeeDataToFile(HashMap<Integer, Employee> employees) {
        try {
...
public class EmployeeManagementApp {
    public static void main(String args[]) {
        ...
        try {
            ...
            CSVFileStorageRetrival.loadEmployeeDataFromFile(employees);
	    //raf.close();
            do {
                outerChoice = 0;
                System.out.println("---------------------------------------------");
	    ...
	    //raf = new RandomAccessFile("EmployeeData.csv", "rw");
            CSVFileStorageRetrival.updateEmployeeDataToFile( employees);
	    //raf.close();
	    scanner.close();
