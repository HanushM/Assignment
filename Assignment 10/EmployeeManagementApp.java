...
class EmployeeID {
    public static int createEID(TreeMap employees) {
        while (true) {
...
abstract class Employee {
    ...
    public static Employee createEmployee(String designation, TreeMap employees) {
    while (true) {  
        try {
    ...
    final public static void display(TreeMap employees) {
	...
	public static void delete(TreeMap employees){
		int delId = 0;
	...
	public static void search(TreeMap employees){
		int searchId = 0;
		Scanner scanner = new Scanner(System.in);
		try{
			System.out.print("Enter Employee ID to Delete:");
